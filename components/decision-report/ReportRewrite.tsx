...
export function ReportRewrite({
  ...
  function rewrite() {
    ...
    const brief = `Rewrite only the supplied paragraph according to the instruction. Put the rewritten paragraph in the decision text of the report. Do not add facts, numerical results, or claims of evidence.\nInstruction: ${instruction}\nParagraph: ${original}`;
